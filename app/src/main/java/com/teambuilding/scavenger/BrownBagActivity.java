    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if(result != null) {
            ...
            if (result.getContents() == null) {
                ...
                //if qr contains data
                if (result.getContents().contains("brownbag")) {
                    if (SharedPreferencesHelper.getInstance().getCount() < 9) {
                        ...
                        SharedPreferencesHelper.getInstance().setActivityIndex(8);
                        ...
                        //Success Activity
                        Intent i = new Intent(BrownBagActivity.this, SuccessActivity.class);
                        startActivity(i);
                        finish();
                    }
                } else {
